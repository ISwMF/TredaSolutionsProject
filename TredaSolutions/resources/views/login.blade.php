						...
						<div class="card-body">
							<form class="contact__form" method="post">
								...
								<div class="row">
									...
									<div class="col-md-12 form-group">
										<input id="id_tienda" name="id_tienda" type="text" class="form-control" placeholder="ID de la tienda" required>
									</div>
									<div class="col-12 form-group">
										<div class="g-recaptcha" data-sitekey="6LfePbgZAAAAAJ6ZF-8kxFxrYJVOeCfGyygQrYPs"></div>
									</div>
									<div class="col-12">
										<input type="submit" class="btn btn-success" value="Ver productos">
									</div>
								</div>
								<!-- end form element -->
							</form>
